...
## Export:
save(list=c("meta_clin","mega_expr"), file=paste0(DIR_OUT,"240217a_mega.RData"), compress=TRUE)
...
write.csv(mega_expr, file=paste0(DIR_OUT,"240217b_df4ml.csv"), row.names=FALSE, quote=FALSE)
